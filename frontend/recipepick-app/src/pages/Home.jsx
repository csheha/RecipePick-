          ...
          <div className="head-container">
            <div className="head-left">
              <div className="tagline">
                Where every recipe has a story to tell!
              </div>
              <div className="main-text">
                <h1 className="main-text-h1">Recipes</h1>
              </div>
              <div className="desc-para">
                <p className="desc-para-text">
                  Cooking is an art that connects people across cultures and
                  traditions. Share your favorite recipes and inspire others to
                  create delicious dishes at home. From savory meals to sweet
                  treats, every recipe tells a story. Let’s make cooking a
                  joyous adventure by exploring diverse flavors and
                  experimenting with new ingredients together!
                </p>
              </div>
            </div>
